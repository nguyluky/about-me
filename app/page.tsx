...
const skillCategories = [
  ...
  },
  {
    ...
    icons:
      "nodejs,express,fastapi,flask,graphql,prisma,docker,nginx,aws,azure,cloudflare",
...
function Title() {
  ...
  return (
    <div className="h-[95px] md:h-[84px] overflow-hidden">
      <div
        className={
          animate ? "ease-in-out duration-700 transition-transform" : ""
        }
        style={{
  ...
  if (!mounted) {
    return (
      <button
        className={
          isMobile
            ? "lg:hidden fixed top-6 right-16 z-50 p-2 hover:bg-secondary rounded-lg transition-colors"
  ...
  return (
    <>
      <div className="min-h-screen bg-background text-foreground">
        <aside
          className="fixed left-6 top-1/2 transform -translate-y-1/2 w-20 flex-col items-center justify-center gap-6 z-40
                    hidden md:flex
                "
        >
          <div className="flex flex-col items-center gap-8">
            ...
            <div className="flex flex-col items-center gap-4 border-t border-border pt-4">
              {contacts.map((e) => (
                <div className="relative group" key={e.title}>
                  <a
                    href={e.link}
                    title={e.title}
                    target="_blank"
        ...
        <main
          className=" flex justify-center h-screen overflow-y-scroll snap-y snap-mandatory scroll-smooth
        ...
        >
          <div className="max-w-full md:max-w-4xl">
            ...
            <section
              id="hero"
              className="snap-start flex items-center min-h-screen py-4"
            >
              <div className=" m-auto">
                <div className="space-y-6">
                  ...
                  <p className="text-lg text-muted-foreground leading-relaxed max-w-2xl">
                    I build systems where software meets the real world — from
                    backend services and APIs to protocol analysis and embedded
                    devices.
                  </p>
            ...
            <section
              id="about"
              className="snap-start flex items-center min-h-screen py-4 border-t"
            >
                  ...
                  <div className="grid lg:grid-cols-2 gap-8 items-start">
                    ...
                    <div className="p-6 border rounded-2xl space-y-5">
                      <p className="text-muted-foreground leading-relaxed">
                        I enjoy turning everyday problems into engineering
                        challenges. Most of my projects start from simple
                        frustrations and grow into complete systems.
                      </p>

                      <p className="text-muted-foreground leading-relaxed">
                        I mainly work on backend systems and low-level problems
                        where software meets real-world constraints. I like
                        understanding how systems work internally, not just
                        using them.
                      </p>

                      <p className="text-muted-foreground leading-relaxed">
                        I’m especially interested in problems that require both
                        system-level thinking and low-level detail — from
                        building APIs to working close to hardware.
                      </p>
                      ...
                      <div className="border-t pt-4 space-y-4">
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground leading-relaxed">
                            I break down complex problems, understand how
                            systems behave, and turn that into practical
                            solutions.
                          </p>
                        </div>
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground leading-relaxed">
                            I enjoy building things that are not only
                            technically interesting, but also useful in
                    ...
                    <div className="gap-4 h-full hidden md:grid">
                      <div className="p-5 border rounded-2xl hover:bg-secondary transition-colors">
                        ...
                        <p className="text-sm text-muted-foreground">
                          Building APIs and services that handle real-world
                          workloads.
                        </p>
                      </div>
                      ...
                      <div className="p-5 border rounded-2xl hover:bg-secondary transition-colors">
                        ...
                        <p className="text-sm text-muted-foreground">
                          Exploring how things work under the hood and analyzing
                          behavior.
                        </p>
                      </div>
                      ...
                      <div className="p-5 border rounded-2xl hover:bg-secondary transition-colors">
                        ...
                        <p className="text-sm text-muted-foreground">
                          Building software that interacts with devices and
                      ...
                      <div className="p-5 border rounded-2xl hover:bg-secondary transition-colors">
                        ...
                        <p className="text-sm text-muted-foreground">
                          Creating tools that solve real problems and improve
                          workflows.
                        </p>
                      </div>
                    </div>
            ...
            <section
              id="skills"
              className="snap-start flex items-center min-h-screen py-4 border-t w-full"
            >
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  ...
                  <div className="group border border-border rounded-lg overflow-hidden hover:border-primary transition-colors">
                    ...
                    <div className="p-6">
                      ...
                      <p className="text-muted-foreground text-sm mb-4">
                        Re-implemented the Android TV remote protocol in C/C++
                        on ESP32 by analyzing network traffic and existing
                        implementations.
                      </p>
                      ...
                      <a
                        href="https://github.com/nguyluky/ESP32_android_tv_remote_v2"
                        target="_blank"
                  ...
                  <div className="group border border-border rounded-lg overflow-hidden hover:border-primary transition-colors">
                    ...
                    <div className="p-6">
                      ...
                      <p className="text-muted-foreground text-sm mb-4">
                        Built an unofficial API by analyzing a university system
                        and extracting data through network inspection and
                        scraping.
                      </p>
                      ...
                      <a
                        href="https://github.com/nguyluky/thongtindaotao_sgu_api"
                        target="_blank"
                        className="inline-flex items-center gap-2 text-primary hover:gap-3 transition-all text-sm font-medium"
                      >
                        View Project
                  ...
                  <div className="group border border-border rounded-lg overflow-hidden hover:border-primary transition-colors">
                    ...
                    <div className="p-6">
                      ...
                      <p className="text-muted-foreground text-sm mb-4">
                        A timetable platform with real-time updates, used by
                        1,500+ students and handling active daily usage.
                      </p>
                      ...
                      <a
                        href="https://github.com/nguyluky/TKB-SGU-UI"
                        target="_blank"
                        className="inline-flex items-center gap-2 text-primary hover:gap-3 transition-all text-sm font-medium"
                      >
                        View Project
                  ...
                  <div className="group border border-border rounded-lg overflow-hidden hover:border-primary transition-colors">
                    ...
                    <div className="p-6">
                      ...
                      <p className="text-muted-foreground text-sm mb-4">
                        Automatically generates API documentation from
                        TypeScript code to keep docs in sync with
                        implementation.
                      </p>
                      ...
                      <a
                        href="https://github.com/nguyluky/express-auto-docs-typesafe"
                        target="_blank"
                        className="inline-flex items-center gap-2 text-primary hover:gap-3 transition-all text-sm font-medium"
                      >
                        View Project
                ...
                <div className="space-y-8">
                  ...
                  <div className="border-l-2 border-primary pl-8 pb-8">
                    ...
                    <p className="text-muted-foreground mb-3">
                      Mentored students in building full-stack applications and
                    ...
                    <ul className="space-y-1 text-sm text-muted-foreground">
                      ...
                      <li>
                        • Helped debug real-world issues and improve coding
                        practices
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="border-l-2 border-muted pl-8 pb-8">
                    ...
                    <p className="text-muted-foreground mb-3">
                      Built and maintained multiple real-world projects focused
                      on backend systems, reverse engineering, and embedded
                      development.
                    </p>
                  ...
                  <div className="border-l-2 border-muted pl-8">
                    ...
                    <p className="text-muted-foreground mb-3">
                      Focused on learning system internals, networking, and
                      embedded development through hands-on projects.
                    </p>
            ...
            <section
              id="contact"
              className="snap-start flex items-center min-h-screen border-t w-full"
            >
              <div className="max-w-4xl mx-auto space-y-10">
                ...
                <div>
                  ...
                  <p className="text-lg text-muted-foreground max-w-2xl">
                    I'm open to interesting projects, collaborations, or just a
                    quick chat. If you're building something or have an idea,
                ...
                <div className="border-t pt-6 space-y-4">
                  ...
                  <p className="text-sm text-muted-foreground max-w-2xl">
                    I build open-source projects and tools. If you find them
                    useful, you can support my work or contribute to help me
                    keep improving them.
                  </p>
                  ...
                  <div className="flex flex-wrap gap-4">
                    ...
                    <a
                      href="https://buymeacoffee.com/nguylukyu"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-2 px-5 py-2 border rounded-lg hover:bg-secondary transition text-sm"
                    >
